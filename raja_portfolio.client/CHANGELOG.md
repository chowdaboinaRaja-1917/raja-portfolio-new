...
- Create Angular project with ng: `ng new raja_portfolio.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`raja_portfolio.client.esproj`).
